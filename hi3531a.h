 ...
 *-----------------------------------------------------------------------*/
#define CONFIG_BOOTCOMMAND	"setenv jpeg_addr 0x42000000;setenv jpeg_size 0x400000;setenv vobuf 0x41000000;nand read 0x42000000 0x7c00000 0x200000;decjpg;startvo 1 36 12;startvl 1 0x41000000 1920 0 0 1920 1080;setenv vobuf 0x41500000;nand read 0x42000000 0x7e00000 0x200000;decjpg;startvo 2 1 0;startvl 3 0x41500000 768 0 0 720 576;mw.b 0x42000000 0xff 0x400000;nand read 0x42000000 0x100000 0x400000;bootm 0x42000000"

//#define CONFIG_BOOTCOMMAND	"nand read 0x42000000 0x100000 0x400000;bootm 0x42000000"
#define CONFIG_BOOTDELAY	0
#define CONFIG_BOOTARGS		"mem=768M console=ttyAMA0,115200 root=/dev/mtdblock2 rootfstype=yaffs2 mtdparts=hinand:1M(boot),4M(kernel),119M(rootfs),4M(logo)"
#define CONFIG_NETMASK		"255.255.255.0"	/* talk on MY local net */
#define CONFIG_IPADDR		"192.168.24.129"	/* static IP I currently own */
#define CONFIG_SERVERIP		"192.168.24.42"	/* current tftp server ip */
#define CONFIG_ETHADDR		"00:00:23:34:45:66"
#define CONFIG_BOOTFILE		"uImage"	/* file to load */
#define CONFIG_BAUDRATE		115200

#define CONFIG_EXTRA_ENV_SETTINGS
#define CONFIG_JPEG_ADDR	"0x42000000"
#define CONFIG_JPEG_SIZE	"0x400000"
#define CONFIG_VOBUF		"0x41000000"
